...
d1 = .9                      # distance in meters of segment 1 in the path
d2 = .9                      # distance in meters of segment 2 in the path
...
for  count, motion in enumerate(motions):
    ...
    log.uniqueFile(voltageread, "voltage")
    log.uniqueFile(motion[0], "Forwardvel")
    log.uniqueFile(motion[1], "Angularvel")
