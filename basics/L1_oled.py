...
def getVoltage():
    ...
    return voltageread # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Scuttle 11", font=font, fill=255)
    ...
    draw.text((0,40),"Voltage @: "+Voltage+"V",font = font,fill=255)
